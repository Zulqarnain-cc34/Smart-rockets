...
class Rocket():
    ...
    def __init__(self, dna=None, theta=30):
        ...
        # self.TRUST_1 = np.random.randn(1,2)
        # self.TRUST_2 = np.random.randn(1,2)
        # self.TRUST_3 = np.random.randn(1,2)
        # self.TRUST_4 = np.random.randn(1,2)
    ...
    def log(self):
        with open("force.txt","a") as log:
            ...
            log.write(f"__________________THRUSTS_______________\n\n")
    ...
    def show(self, win):
        self.rectRotated(win, WHITE,self.pos,12, self.theta)
    ...
    def torque(self, r, force):
        # print("Cross: ",np.cross(r,force))
        return np.cross(r,force) 
    
    def sum_of_all_torques(self):
        sum = self.torque(self.TRUSTER_1,self.TRUST_1) + \
                         self.torque(self.TRUSTER_2,self.TRUST_2) + \
                         self.torque(self.TRUSTER_3,self.TRUST_3) + \
                         self.torque(self.TRUSTER_4,self.TRUST_4)
